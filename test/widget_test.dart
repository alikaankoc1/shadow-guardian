...
void main() {
  ...
  testWidgets('opens start, world and stage menus in order', (tester) async {
    ...
    expect(find.text('Meslekler'), findsOneWidget);
    ...
    await tester.scrollUntilVisible(
      find.text('Masal Dünyası'),
      200,
      scrollable: find.byType(Scrollable).first,
    );
    expect(find.text('Masal Dünyası'), findsOneWidget);

    await tester.scrollUntilVisible(
      find.text('Sürpriz Dünya'),
      200,
      scrollable: find.byType(Scrollable).first,
    );
    expect(find.text('Sürpriz Dünya'), findsOneWidget);
